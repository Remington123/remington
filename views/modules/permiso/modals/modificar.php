<?php
	...
	$accion = "modificar";
	$modulo = "permiso";
	$controlador = $modulo.'/PermisoController';
							...
							<input type="hidden" id="opcion" name="opcion" value="'. $accion.'">
								<div class="form-group">
									 <label  class="col-sm-2 control-label"
	                              		for="idtipousuario">Idtipousuario</label>
									<div class="col-sm-10">
										<input id="idtipousuario" name="idtipousuario" type="text" class="form-control">
									</div>
								</div>							
								<div class="form-group">
									 <label  class="col-sm-2 control-label"
	                              		for="idmodulo">Idmodulo</label>
									<div class="col-sm-10">
										<input id="idmodulo" name="idmodulo" type="text" class="form-control">
									</div>
								</div>
