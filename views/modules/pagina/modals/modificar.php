							...
							<input type="hidden" id="opcion" name="opcion" value="'. $accion.'">
								<div class="form-group">
									 <label  class="col-sm-2 control-label"
	                              		for="pagina>Pagina</label>
									<div class="col-sm-10">
										<input id="pagina" name="pagina" type="text" class="form-control">
									</div>
								</div>							
								<div class="form-group">
									 <label  class="col-sm-2 control-label"
	                              		for="icono">Iconp</label>
									<div class="col-sm-10">
										<input id="icono" name="icono" type="text" class="form-control">
									</div>
								</div>
