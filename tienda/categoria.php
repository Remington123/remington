		...
		<div class="col-md-4 products-left">
			...
			<div class="css-treeview">
				...
				<ul class="tree-list-pad">
					<li class="categoria" data-idcategoriaproducto="1"><label for="item-0"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Camisas</label>
					</li>
					<li class="categoria" data-idcategoriaproducto="2"><label for="item-1"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Chalecos</label>
					</li>
					<li class="categoria" data-idcategoriaproducto="3"><label for="item-2"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Corbata</label>
					</li>
					<li class="categoria" data-idcategoriaproducto="4"><label for="item-2"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Saco</label>
					</li>
					<li class="categoria" data-idcategoriaproducto="5"><label for="item-2"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Pantalón</label>
					</li>
				</ul>
			</div>
